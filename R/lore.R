...
lore_says_hi = function() {
  g = magick::image_read(system.file("img/hi.gif"))
  print(g, info = FALSE)
...
lore_says_bye = function() {
  g = magick::image_read(system.file("img/bye.gif"))
  print(g, info = FALSE)
...
lore_is_bored = function() {
  g = magick::image_read(system.file("img/bored.gif"))
  print(g, info = FALSE)
...
lore_is_excited = function() {
  g = magick::image_read(system.file("img/excited.gif"))
  print(g, info = FALSE)
...
lore_is_frustrated = function() {
  g = magick::image_read(system.file("img/frustrated.gif"))
  print(g, info = FALSE)
...
lore_is_happy = function() {
  g = magick::image_read(system.file("img/happy.gif"))
  print(g, info = FALSE)
...
lore_is_lonely = function() {
  g = magick::image_read(system.file("img/lonely.gif"))
  print(g, info = FALSE)
...
lore_is_sad = function() {
  g = magick::image_read(system.file("img/sad.gif"))
  print(g, info = FALSE)
...
lore_is_tired = function() {
  i = magick::image_read(system.file("img/active.png"))
  print(i, info = FALSE)
...
lore_is_feeling_stupid = function() {
  g = magick::image_read(system.file("img/stupid.gif"))
  print(g, info = FALSE)
...
lore_is_feeling_ugly = function() {
  g = magick::image_read(system.file("img/ugly.gif"))
  print(g, info = FALSE)
...
lore_is_feeling_useless = function() {
  g = magick::image_read(system.file("img/useless.gif"))
  print(g, info = FALSE)
...
lore_is_needing_attention = function() {
  g = magick::image_read(system.file("img/attention.gif"))
  print(g, info = FALSE)
